...
class EditBde extends Component {
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation($id: ID!, $firstName: String, $lastName: String, $email: String, $bdeId: ID!, $imageId: String, $imageUrl: String, $phone: String, $areasIds: [ID!]){
  
              updateUser(id: $id, name: $firstName, email: $email){
                id
              }
              updateBDE( id: $bdeId, imageId: $imageId, imageUrl: $imageUrl, firstName: $firstName, lastName: $lastName, phone: $phone, areasIds: $areasIds){
                id
              }
            }
          `
                    ...
                    <div className="col-md-9">
                      <Multiselect
                       onChange={this.handleSelectChange}
                        data={this.state.dataz.map((areax) => (
                           
                           {id: areax.id, name: areax.name}
                        ...
                        defaultValue={this.state.areas.map((area) => (
