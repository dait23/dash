...
class EditPayment extends Component {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              ...
              name:results.data.Payment.name,
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updatePayment ($id: ID!, $name: String!, $slug: String!){
              updatePayment (id: $id, name: $name, slug: $slug){
                id
                name
                slug              
              }
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <strong>Edit </strong> Payment Type
              </div>
