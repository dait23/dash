...
class NewFacility extends Component {
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "setting/facility-partners/all";
...
const addMutation = gql`
  mutation addBrand($name: String!, $slug: String!) {
    createFacility(name: $name, slug: $slug) {
      id
      name
      slug
    }
...
const PageWithMutation = graphql(addMutation, { name: 'addBrand' })(NewFacility)
