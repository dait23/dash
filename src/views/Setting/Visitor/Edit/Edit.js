...
class EditVisitor extends Component {
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.VisitorType,
              id:results.data.VisitorType.id,
              name:results.data.VisitorType.name,
              slug:results.data.VisitorType.slug,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateVisitorType ($id: ID!, $name: String!, $slug: String!){
              updateVisitorType (id: $id, name: $name, slug: $slug){
                id
                name
                slug              
              }
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <strong>Edit </strong> Visitor Type
              </div>
