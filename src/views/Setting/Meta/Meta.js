  ...
  getData(){
   ...
   onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateMeta ($id: ID!, $title: String!, $slug: String!, $email: String!, $description: String!, $imageUrl: String!, $imageId: String!, $keywords: String!, $address: String!, $phone: String!, $facebook: String!, $twitter: String!, $instagram: String!){
              updateMeta (id: $id, title: $title, slug: $slug, email: $email, description: $description, imageId: $imageId, imageUrl: $imageUrl, keywords: $keywords, address: $address, phone: $phone, facebook: $facebook, twitter: $twitter, instagram: $instagram){
                id
                title
                slug
                email
                ...
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                   ...
                   <div className="form-group row">
                    ...
                    <div className="col-md-9">
                      <input type="text"  value={this.state.email} name="email" className="form-control" placeholder="Email"
