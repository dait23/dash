...
class EditEmployment extends Component {
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Employment,
              id:results.data.Employment.id,
              title:results.data.Employment.title,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateEmployment ($id: ID!, $title: String!){
              updateEmployment (id: $id, title: $title){
                id
                title            
              }
            }
