...
class NewCategory extends Component {
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "setting/category/all";
...
const addMutation = gql`
  mutation addCategory($name: String!, $slug: String) {
    createMainCategory(name: $name, slug: $slug) {
      id
      name
      slug
    }
...
const PageWithMutation = graphql(addMutation, { name: 'addBrand' })(NewCategory)
