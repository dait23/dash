...
class NewBrandType extends Component {
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "setting/brand-type/all";
   //window.location.reload(true);
  }

}
const addMutation = gql`
  mutation addBrand($name: String!, $slug: String!) {
    createBrandType(name: $name, slug: $slug) {
      id
      name
      slug
    }
...
const PageWithMutation = graphql(addMutation, { name: 'addBrand' })(NewBrandType)
