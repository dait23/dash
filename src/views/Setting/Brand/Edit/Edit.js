...
class EditBrandType extends Component {
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.BrandType,
              id:results.data.BrandType.id,
              name:results.data.BrandType.name,
              slug:results.data.BrandType.slug,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateBrandType ($id: ID!, $name: String!, $slug: String!){
              updateBrandType (id: $id, name: $name, slug: $slug){
                id
                name
                slug              
              }
          ...
          <div className="col-md-12">
            <div className="card">
              ...
              <div className="card-footer">
                ...
                <Link to={'/setting/brand-type/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
