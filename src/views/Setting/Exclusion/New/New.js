...
class NewExclusion extends Component {
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "setting/exclusion/all";
...
const addMutation = gql`
  mutation addBrand($name: String!) {
    createExclusion(name: $name) {
      id
    }
  }
`

const PageWithMutation = graphql(addMutation, { name: 'addBrand' })(NewExclusion)
