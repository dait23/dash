...
class EditCountry extends Component {
  ...
  getData(){
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              data : results.data.Area,
              id:results.data.Area.id,
              name:results.data.Area.name,
              slug:results.data.Area.slug,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateArea ($id: ID!, $name: String!, $slug: String!){
              updateArea (id: $id, name: $name, slug: $slug){
                id
                name
                slug              
              }
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <strong>Edit </strong> Area / REgional
              </div>
