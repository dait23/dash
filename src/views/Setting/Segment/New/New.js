...
class NewSegment extends Component {
          ...
          <div className="col-md-12">
            <div className="card">
              ...
              <div className="card-block">
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                    <label className="col-md-3 form-control-label" htmlFor="text-input">Name Segment</label>
              ...
              <div className="card-footer">
                ...
                <Link to={'/setting/segment/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "setting/segment/all";
   //window.location.reload(true);
  }

}
const addMutation = gql`
  mutation addSegment($name: String!, $slug: String) {
    createSegment(name: $name, slug: $slug) {
      id
    }
  }
`

const PageWithMutation = graphql(addMutation, { name: 'addBrand' })(NewSegment)
