...
class EditMerchant extends Component {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              ...
              firstName:results.data.User.merchant.firstName,
              lastName:results.data.User.merchant.lastName,
              imageId:results.data.User.merchant.imageId,
              imageUrl:results.data.User.merchant.imageUrl,
              phone:results.data.User.merchant.phone,
              mId:results.data.User.merchant.id,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation($id: ID!, $firstName: String, $lastName: String, $email: String, $mId: ID!, $imageId: String, $imageUrl: String, $phone: String){
  
              updateUser(id: $id, name: $firstName, email: $email){
                id
              }
              updateMerchant( id: $mId, imageId: $imageId, imageUrl: $imageUrl, firstName: $firstName, lastName: $lastName, phone: $phone){
                id
              }
            }
          `
          ...
          <div className="col-md-12">
            <div className="card">
              ...
              <div className="card-footer">
                ...
                <Link to={'/merchant/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
