...
class NewMerchant extends Component {
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <strong>Add </strong> New Merchant
              </div>
  ...
  handlePost = async () => {
   ...
   window.location= MainLink + "merchant/all";
...
const addMutation = gql`
 mutation SignupUserMutation ($email: String!, $password: String!, $jabatan: String, $firstName: String, $lastName: String) {
    signupMerchant(email: $email, password: $password, jabatan: $jabatan, firstName: $firstName, lastName: $lastName) {
      id
      token
    }
  }
...
const PageWithMutation = graphql(addMutation, { name: 'addUser' })(NewMerchant)
