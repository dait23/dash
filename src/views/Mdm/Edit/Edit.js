...
class EditMdm extends Component {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            that.setState({
              ...
              firstName:results.data.User.mdm.firstName,
              lastName:results.data.User.mdm.lastName,
              imageId:results.data.User.mdm.imageId,
              imageUrl:results.data.User.mdm.imageUrl,
              phone:results.data.User.mdm.phone,
              mdmId:results.data.User.mdm.id,
              loading:false
             });
            //...
          })
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation($id: ID!, $firstName: String, $lastName: String, $email: String, $mdmId: ID!, $imageId: String, $imageUrl: String, $phone: String){
  
              updateUser(id: $id, name: $firstName, email: $email){
                id
              }
              updateMDM( id: $mdmId, imageId: $imageId, imageUrl: $imageUrl, firstName: $firstName, lastName: $lastName, phone: $phone){
                id
              }
            }
          `
          ...
          fetch(query, queryVars, opts).then(function (results) {
            ...
            //that.getData();
            window.location= MainLink + "mdm/all";
          ...
          <div className="col-md-12">
            <div className="card">
              ...
              <div className="card-footer">
                ...
                <Link to={'/mdm/all'} className="btn btn-sm btn-danger"><i className="fa fa-ban"></i>&nbsp; Cancel</Link>
              </div>
            </div>
