...
class NewMdm extends Component {
...
const addMutation = gql`
 mutation SignupUserMutation ($email: String!, $password: String!, $jabatan: String, $firstName: String, $lastName: String) {
    signupMdm(email: $email, password: $password, jabatan: $jabatan, firstName: $firstName, lastName: $lastName) {
      id
      token
    }
  }
...
const PageWithMutation = graphql(addMutation, { name: 'addUser' })(NewMdm)
