 ...
 //}
  ...
  onUpdatePress() {
     ...
     var fetch = require('graphql-fetch')(MainApi)
          ...
          var query = `
            mutation updateBanner ($id: ID!, $title: String!, $link: String!, $imageId: String, $imageUrl: String!, $description: String!){
              updateBanner (id: $id, title: $title, link: $link, imageId: $imageId, imageUrl: $imageUrl, description: $description){
                id
                title
                link
                imageId
                ...
                <form className="form-horizontal">
                  ...
                  <div className="form-group row">
                   ...
                   <div className="form-group row">
                    ...
                    <div className="col-md-9">
                      <input type="text" id="text-input" value={this.state.link} name="link" className="form-control" placeholder="Title"
