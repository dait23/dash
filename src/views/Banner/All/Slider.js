          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                ...
                <Link to={'/banner/new'} className="btn btn-success btn-sm pull-right"><i className="fa fa-plus"></i>&nbsp; Add Slider</Link>
              </div>
...
const ListPageWithData = graphql(FeedQuery)(Banner)
