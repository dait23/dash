    ...
    return (
      <div className="animated fadeIn">
        ...
        <Row>
         ...
         <CardGroup>
          <Widget04 icon="icon-layers" color="info" header={this.state.datax} value="25">My Workflow</Widget04>
          <Widget04 icon="icon-layers" color="success" header={this.state.datav} value="25">My FU1</Widget04>
          <Widget04 icon="icon-layers" color="warning" header={this.state.datay} value="25">My FU2</Widget04>
          <Widget04 icon="icon-layers" color="primary" header={this.state.dataz} value="25">My FU3</Widget04>
          <Widget04 icon="icon-people" color="primary" header={this.state.datab} value="25">MDM Teams</Widget04>
